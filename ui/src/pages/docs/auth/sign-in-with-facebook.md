...
Sign-in with Facebook provider is currently not available in Node.js. For React Native and React VR, please see [here](/docs/auth/oauth-react-native-vr.html).
